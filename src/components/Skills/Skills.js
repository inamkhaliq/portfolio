                ...
                <div className='flex gap-5 flex-wrap justify-center '>
                    {
                        Skills.map((skill, indx) => {
                            return (
                                <div key={indx} className='bg-myBlue hover:bg-blue-700 hover:text-white group relative duration-300 transition-all shadow-xl rounded-xl  lg:max-w-[33.33333%] md:max-w-[50%] xl:max-w-[25%]  max-w-full'>
