                ...
                <div className='flex justify-between flex-wrap'>
                    ...
                    <div className='max-w-full md:max-w-[40%] p-2'>
                        ...
                        <div className='flex justify-start gap-3'>
                            <a href="https://www.facebook.com/inamdotkhaliq" className='p-3 inline-block rounded-full border border-solid fill-gray-500 hover:fill-white hover:bg-myBlue'>
                            ...
                            <a href="https://twitter.com/UhhR_Babe" className='p-3 inline-block rounded-full border border-solid fill-gray-500 hover:fill-white hover:bg-myBlue'>
                                <svg width="14" height="14" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                    <path d="M389.2 48h70.6L305.6 224.2 487 464H345L233.7 318.6 106.5 464H35.8L200.7 275.5 26.8 48H172.4L272.9 180.9 389.2 48zM364.4 421.8h39.1L151.1 88h-42L364.4 421.8z"/>
                                </svg>
                            </a>
                            <a href="https://github.com/inamkhaliq" className='p-3 inline-block rounded-full border border-solid fill-gray-500 hover:fill-white hover:bg-myBlue'>
                            ...
                            <a href="https://www.linkedin.com/in/inamkhaliq/" className='p-3 inline-block rounded-full border border-solid fill-gray-500 hover:fill-white hover:bg-myBlue'>
