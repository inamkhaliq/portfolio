            ...
            <div className='max-w-screen-xl divide-solid border-b border-gray-500 m-auto px-10 sm:py-32 py-16'>
                <div className='flex justify-between flex-wrap'>
                    <div className='px-2 max-w-full md:max-w-[60%]'>
                        ...
                        <p className='font-medium text-gray-500 max-w-xl '>
                            A skilled web developer creating functional and beautiful websites, dedicated to staying up-to-date
                    ...
                    <div className='max-w-full md:max-w-[40%] p-2'>
                        ...
                        <p className='mb-10 font-medium text-gray-500 '>
                            Together, we can build bridges that transcend mere acquaintance, fostering relationships grounded in authenticity and understanding. So, let's connect—let's embark on a journey of mutual growth, support, and camaraderie.
                        </p>
